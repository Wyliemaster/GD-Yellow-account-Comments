...
try {
    ...
    if (save.search('<k>0</k><d><k>kCEK</k><i>4</i><k>k2</k><s>Unknown</s><k>k5</k><s>-</s>') != '-1') {
        let start = save.slice(save.search('<k>0</k><d><k>kCEK</k><i>4</i><k>k2</k><s>Unknown</s><k>k5</k><s>-</s>'), save.length)
        ...
        let saveEdit = save.replace('<k>GLM_03</k><d>', '<k>GLM_03</k><d><k>0</k><d><k>kCEK</k><i>4</i><k>k2</k><s>Unknown</s><k>k5</k><s>-</s><k>k21</k><i>4</i><k>k50</k><i>29</i></d>')
        fs.writeFileSync('build/CCGameManager.dat', saveEdit)
